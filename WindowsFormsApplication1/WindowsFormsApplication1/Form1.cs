    ...
    public partial class Form1 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if (plano.Count > 0)
            {
                for (int j = 1; j <= plano.Count / 2; j++)
                {
                        ...
                        myCanvas1.points.Add(new Point((Convert.ToInt32(plano[j.ToString() + 2.ToString()].Text)), (Convert.ToInt32(plano[i.ToString() + j.ToString()].Text))));
        ...
        private void comboBox6_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (plano.Count > 0) { 
                    ...
                    {
                        for (int i = 0; i < 2; i++){
                            this.Controls.Remove(plano[i.ToString()+j.ToString()]);
                    }
                }
                    plano.Clear();
            }
            ...
            for (int j = 1; j <= Convert.ToInt32(comboBox6.Text); j++)
            {
                for (int i = 0; i <2; i++)
                {
                    ...
                    textBox.Size = new System.Drawing.Size(31, 20);
                    this.Controls.Add(textBox);
                    plano.Add(i.ToString() + j.ToString(), textBox);
                }
            }
        }
